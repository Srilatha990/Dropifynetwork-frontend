            ...
            <li key={children._id}>
              {children.children.length > 0 ? (
                <a
                  ...
                  className="flex items-center font-serif pr-2 text-sm text-gray-600  py-1 cursor-pointer"
                >
                ...
                <a
                  ...
                  className="flex items-center font-serif py-1 text-sm text-gray-600  cursor-pointer"
                >
                  ...
                  {children.children.map((subChildren) => (
                    <li key={subChildren._id}>
                      <a
                        ...
                        className="flex items-center font-serif py-1 text-sm text-gray-600 h cursor-pointer"
                      >
                        <span className="text-xs text-gray-500 pr-2">
                          <IoRemoveSharp />
                        </span>
