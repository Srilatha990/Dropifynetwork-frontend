...
class MyDocument extends Document {
  ...
  render() {
    ...
    return (
      <Html lang="en">
        <Head>
          <link rel="icon" href={setting?.favicon || "/logo.jpg"} />
          <meta
            property="og:title"
            content={
              setting?.meta_title ||
              "	DropifyNetwork - React Grocery & Organic Food Store e-commerce Template"
            }
          />
          ...
          <meta
            property="og:url"
            content={
              setting?.meta_url || "https://	Kachabazzar-store.vercel.app/"
            }
          />
          <meta
            property="og:image"
