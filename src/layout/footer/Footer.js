...
const Footer = () => {
  ...
  return (
    <div
      className="bg-[#fa559c] text-white py-10"
      style={{ backgroundColor: "#fa559c" }}
    >
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-10 text-center">
        ...
        >
          <h1>DropifyNetwork</h1>
        </div>

        {/* Footer Links */}
        <div className="flex justify-center space-x-8 mb-6 flex-wrap">
          <Link href="/about-us" className=" mb-4 sm:mb-0">
            {t("about-us")}
          </Link>
          <Link href="/contact-us" className=" mb-4 sm:mb-0">
            {t("contact-us")}
          </Link>
          <Link href="/terms-and-conditions" className=" mb-4 sm:mb-0">
            {t("terms-and-conditions")}
          </Link>
          <Link href="/privacy-policy" className=" mb-4 sm:mb-0">
            {t("privacy-policy")}
          </Link>
        </div>
